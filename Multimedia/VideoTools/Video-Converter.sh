...
####################################################################
# Installation:
# Place the script in the Nautilus scripts folder (/home/YourUserName/.gnome2/nemo-scripts)
...
# http://g-scripts.sourceforge.net/nemo-scripts/Multimedia/Image/NIS
# http://g-scripts.sourceforge.net/nemo-scripts/Multimedia/Image/convert_to_jpeg
